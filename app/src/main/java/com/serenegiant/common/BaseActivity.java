	...
	protected void checkPermissionResult(final int requestCode, final String permission, final boolean result) {
		...
		if (!result && (permission != null)) {
			if (Manifest.permission.RECORD_AUDIO.equals(permission)) {
				                                showToast(com.example.myapplication.R.string.permission_audio);
			}
			if (Manifest.permission.WRITE_EXTERNAL_STORAGE.equals(permission)) {
				                                showToast(com.example.myapplication.R.string.permission_ext_storage);
			}
			if (Manifest.permission.INTERNET.equals(permission)) {
				                                showToast(com.example.myapplication.R.string.permission_network);
			}
		}
	}
	...
	protected boolean checkPermissionWriteExternalStorage() {
		if (!PermissionCheck.hasWriteExternalStorage(this)) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE,
				                                com.example.myapplication.R.string.permission_title, com.example.myapplication.R.string.permission_ext_storage_request,
	...
	protected boolean checkPermissionAudio() {
		if (!PermissionCheck.hasAudio(this)) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_AUDIO_RECORDING,
				                                com.example.myapplication.R.string.permission_title, com.example.myapplication.R.string.permission_audio_recording_request,
	...
	protected boolean checkPermissionNetwork() {
		if (!PermissionCheck.hasNetwork(this)) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_NETWORK,
				                                com.example.myapplication.R.string.permission_title, com.example.myapplication.R.string.permission_network_request,
	...
	protected boolean checkPermissionCamera() {
		if (!PermissionCheck.hasCamera(this)) {
			MessageDialogFragmentV4.showDialog(this, REQUEST_PERMISSION_CAMERA,
				com.example.myapplication.R.string.permission_title, com.example.myapplication.R.string.permission_camera_request,
